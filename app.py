...
def send_otp_email(recipient_email, otp_code):
    ...
    try:
        ...
        msg['Subject'] = f"AI Lab Report Interpreter - Verification Code: {otp_code}"
        ...
        <body style="font-family: 'Inter', sans-serif; background-color: #060913; color: #f3f4f6; padding: 40px;">
            <div style="max-width: 500px; margin: 0 auto; background: rgba(13, 20, 38, 0.95); border: 1px solid rgba(255,255,255,0.08); border-radius: 20px; overflow: hidden; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.5);">
                <div style="background: linear-gradient(135deg, #6366f1 0%, #06b6d4 100%); padding: 30px; text-align: center;">
                    <h1 style="color: white; margin: 0; font-size: 24px; font-family: 'Outfit', sans-serif;">AI Lab Report Interpreter</h1>
                    <p style="color: rgba(255,255,255,0.8); margin: 5px 0 0 0; font-size: 13px;">Clinical Insights Co-pilot</p>
                </div>
                <div style="padding: 40px 30px; text-align: center;">
                    <p style="font-size: 16px; margin-top: 0; color: #f3f4f6;">Hello,</p>
                    <p style="font-size: 14px; color: #a1a1aa; line-height: 1.6;">Use the following One-Time Password (OTP) to sign in or register on AI Lab Report Interpreter. This code will expire in 10 minutes.</p>
                ...
                <div style="background: rgba(0, 0, 0, 0.2); padding: 20px; text-align: center; font-size: 11px; color: #71717a; border-top: 1px solid rgba(255,255,255,0.05);">
                    &copy; 2026 AI Lab Report Interpreter. Secure Clinical Co-pilot.
                </div>
            </div>
        </body>
        </html>
...
def redact_personal_info(text: str) -> str:
    ...
    # Redact standard Patient Name lines: e.g. Patient Name: John Doe
    text = re.sub(r'(?i)(patient\s*name|patient\s*:\s*|name\s*:\s*)([^\n,;]+)', r'\1[REDACTED NAME]', text)
    # Redact date of birth / DOB
